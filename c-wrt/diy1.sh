...
# fit for bypass
mv package/bypass/luci-app-bypass package/bypass/smartdns package/bypass/lua-maxminddb package/bypass/trojan-plus package/helloworld && rm -rf package/bypass
